...
<!-- id: ase-x01-survey-grad -->
#### 🙋 **Graduate Student Background & AI Coding Survey (6 Questions)**

Question 1: What is your prior academic background in Software Engineering (SE) courses?
...
Question 2: How would you describe your practical software development experience?
...
Question 3: Which software engineering practices have you actively practiced in projects?
...
Question 4: How frequently do you use Generative AI coding assistants (e.g., GitHub Copilot, Cursor, ChatGPT, Claude)?
...
Question 5: In which area do you find AI coding tools most helpful in your development workflow?
...
Question 6: How do you verify and trust AI-generated code before adopting it?
...
[課堂互動](https://nlhsueh.github.io/nickedupocket/#/student/ase-x01-survey-grad)

<img src="../img/chX01/ase-x01-survey-grad.png" width="120">

---

<!-- id: ase-x01-survey-undergrad -->
#### 🙋 **專班大學生背景與 AI 輔助開發問卷 (7題問卷)**

**第 1 題：請問你過去修習軟體工程相關課程的經歷為何？**
...
**第 3 題：在過往的專案或開發過程中，你熟悉並常使用哪些軟體工程實務？**
...
**第 4 題：在日常學習、工作或撰寫程式時，你使用 AI 程式輔助工具（如 Copilot、Cursor、ChatGPT、Claude）的頻率為何？**
...
**第 5 題：你覺得目前生成式 AI 對你的程式開發在哪一方面幫助最大？**
...
**第 6 題：當使用 AI 產生程式碼後，你通常會如何確認其正確性與品質？**
...
**第 7 題（簡答）：請問你過去或目前的主要專業領域為何？（例如：語文、設計、製造、金融、醫療、行政、資通訊等）**

[課堂互動](https://nlhsueh.github.io/nickedupocket/#/student/ase-x01-survey-undergrad)

<img src="../img/chX01/ase-x01-survey-undergrad.png" width="120">

---

<!-- id: ase-x01-game -->
#### 🙋 **Classroom Challenge Game: ISO 25010 Product Quality Characteristics Match-Up (10 Questions)**

Question 1: [ATM Cash Dispenser Failure] A customer withdraws $1,000 from an ATM. The system deducts the amount from the account balance and prints a transaction receipt, but the cash dispenser mechanism jams and dispenses no bills while the account remains debited. Which ISO 25010 product quality characteristic is primarily violated?
...
Question 4: [Spaghetti Code Ripple Effect] When adding a simple "nickname" attribute to the user profile schema, the engineering team encounters cascading compile-time errors across 8 unrelated services (Cart, Billing, Recommendations, etc.), requiring 3 days of arduous refactoring. Which ISO 25010 quality characteristic is severely deficient?
...
Question 6: [Incompatible Cross-System Date Formats] An e-commerce system integrates with a third-party courier logistics API. Due to conflicting date format specifications (`YYYY-MM-DD` vs `DD/MM/YYYY`), all batch shipment dispatches fail to process. Which ISO 25010 quality characteristic is primarily challenged or violated?
...
Question 7: [Direct Object Reference Exposes User Data] An attacker modifies the profile URL parameter in a web browser from `userId=1001` to `userId=1002`. The backend performs no authorization verification and immediately returns another customer's complete credit card details and residential address. Which ISO 25010 quality characteristic does this critical vulnerability violate?
...
[課堂互動](https://nlhsueh.github.io/nickedupocket/#/student/ase-x01-game)

<img src="../img/chX01/ase-x01-game.png" width="120">
