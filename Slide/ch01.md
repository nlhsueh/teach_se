...
<div class="split55">
  ...
  * **The Software Crisis (1960s-1970s):**
  ...
  <div class="right">
    <img src="images/ch01/software_crisis.png" alt="Software Crisis" />
  </div>
</div>
...
## Agile & AI-Powered Software Engineering

* **Agile and Modern Practices (2000s):**
  * Emphasizes flexibility, collaboration, and iterative development.
  * Transition from rigid plans to responsive development cycles.

* **AI-Powered Software Engineering (Present & Future):**
  * Automates repetitive tasks, generates boilerplate code, and offers intelligent insights.
  * Accelerates development, enhances quality, and shifts human focus to complex design and creative problem-solving.
...
<div class="split64">
  <div class="left">
    <blockquote>
      * When the codebase and the system grow large, ad-hoc coding fails. **Software Engineering** is required.
      * Is Software Engineering just coding?
    </blockquote>

  </div>
  <div class="right">
    <img src="images/ch01/programming_vs_se.png" alt="Programming vs Software Engineering" />
  </div>
</div>
