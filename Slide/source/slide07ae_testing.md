...
<div class="centered-image">
  <img src="../../img/ch07/testing_principles.svg" alt="7 Testing Principles Overview" />
</div>
...
<div class="centered-image">
  <img src="../../img/ch07/testing_types.svg" alt="Spectrum of Software Testing Types" />
</div>
...
* **D.** It replaces the need for user acceptance testing.
  ...
  <div class="ccq-logo">
    <img src="../../img/ch07a/question_icon.svg" alt="Question" />
  </div>
</div>
...
* **Explanation:** Dijkstra stated: *"Program testing can be used to show the presence of bugs, but never to show their absence!"*
  ...
  <div class="ccq-logo">
    <img src="../../img/ch07a/answer_icon.svg" alt="Answer" />
  </div>
</div>
...
4. Feeding random, malformed inputs into an app to uncover crashes and buffer overflows is called **`___`** testing.
  ...
  <div class="fill-blank-logo">
    <img src="../../img/ch07a/fill_blank_icon.svg" alt="Quiz" />
  </div>
</div>
...
4. Feeding random, malformed inputs into an app to uncover crashes and buffer overflows is called **fuzz** testing.
  ...
  <div class="fill-blank-logo">
    <img src="../../img/ch07a/fill_blank_answer_icon.svg" alt="Quiz Answers" />
  </div>
</div>
