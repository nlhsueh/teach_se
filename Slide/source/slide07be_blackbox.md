...
<div class="centered-image">
  <img src="../../img/ch07/black_vs_white_box.svg" alt="Black Box vs White Box" />
</div>
...
<div style="text-align: center; margin-top: 10px;">
  <img src="../../img/ch07/black_box_methods.svg" style="max-height: 480px;" alt="5 Black-Box Testing Techniques" />
</div>
...
<div style="text-align: center; margin-top: 10px;">
  <img src="../../img/ch07/binary_search_ep_table.svg" style="max-height: 380px;" alt="Binary Search Test Cases Table" />
</div>
...
<div style="text-align: center; margin-top: 10px;">
  <img src="../../img/ch07/nextdate_ep_table.svg" style="max-height: 380px;" alt="nextDate Test Cases Table" />
</div>
...
* **D.** Because BVA only tests valid partitions and ignores invalid inputs.
  ...
  <div class="ccq-logo">
    <img src="../../img/ch07b/question_icon.svg" alt="Question" />
  </div>
</div>
...
* **Explanation:** Off-by-one errors (&lt; vs &le;) mean defects concentrate heavily at boundaries.
  ...
  <div class="ccq-logo">
    <img src="../../img/ch07b/answer_icon.svg" alt="Answer" />
  </div>
</div>
...
4. **`___`** testing ensures every pair of input parameters is tested together at least once, avoiding combinatorial explosion.
  ...
  <div class="fill-blank-logo">
    <img src="../../img/ch07b/fill_blank_icon.svg" alt="Quiz" />
  </div>
</div>
...
4. **All-pairs (pairwise)** testing ensures every pair of input parameters is tested together at least once.
  ...
  <div class="fill-blank-logo">
    <img src="../../img/ch07b/fill_blank_answer_icon.svg" alt="Quiz Answers" />
  </div>
</div>
