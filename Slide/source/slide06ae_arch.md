...
* **D.** Physical View
  ...
  <div class="ccq-logo">
    <img src="../../img/ch06/question_icon.svg" alt="Question" />
  </div>
</div>
...
* **Explanation:** The Physical View (Deployment View) maps software components to physical hardware processors and network topology.
  ...
  <div class="ccq-logo">
    <img src="../../img/ch06/answer_icon.svg" alt="Answer" />
  </div>
</div>
...
<div class="split55">
  ...
  * **Advantage:** Separates data management from presentation, enabling multiple views of the same data.
  ...
  <div class="right">
    <img src="../../img/ch06/mvc_structure.png" alt="MVC Architecture" />
  </div>
</div>
...
<div class="split55">
  ...
  * **Advantage:** Allows complete layer replacement if interfaces remain stable.
  ...
  <div class="right">
    <img src="../../img/ch06/generic_layered.png" alt="Generic Layered Architecture" />
  </div>
</div>
...
<div class="split55">
  ...
  * **Examples:** IDEs (Eclipse, VS Code), CAD systems, Medical Record databases.
  ...
  <div class="right">
    <img src="../../img/ch06/repository_arch.png" alt="Repository Architecture" />
  </div>
</div>
...
<div class="split55">
  ...
  * **Disadvantages:**
  ...
  <div class="right">
    <img src="../../img/ch06/client_server_arch.png" alt="Client Server Architecture" />
  </div>
</div>
...
<div class="split55">
  ...
  * **Best Used For:** Batch data processing, invoice processing, compilers.
  ...
  <div class="right">
    <img src="../../img/ch06/pipe_filter_arch.png" alt="Pipe and Filter Architecture" />
  </div>
</div>
...
4. **`___`** architecture decomposes a monolithic application into small, independently deployable services with decentralized data.
  ...
  <div class="fill-blank-logo">
    <img src="../../img/ch06/fill_blank_icon.svg" alt="Quiz" />
  </div>
</div>
...
4. **Microservices** architecture decomposes a monolithic application into small, independently deployable services with decentralized data.
  ...
  <div class="fill-blank-logo">
    <img src="../../img/ch06/fill_blank_answer_icon.svg" alt="Quiz Answers" />
  </div>
</div>
