...
style: |
  ...
  section.enlarged-image-slide {
    padding: 0 !important;
  }
  section.enlarged-image-slide::after {
    display: none !important;
  }
  section.enlarged-image-slide header,
  section.enlarged-image-slide footer {
    display: none !important;
  }
  section.enlarged-image-slide div.centered-image {
    display: flex;
    justify-content: center;
    align-items: center;
    width: 100%;
  ...
  section.enlarged-image-slide div.centered-image img {
    width: 100%;
    height: 100%;
    object-fit: contain;
...
<div style="text-align: center; margin-top: 10px;">
  <img src="../../img/ch04/nfr_classification.svg" style="max-height: 480px;" alt="NFR Classification" />
</div>
...
* **D.** Domain Requirements
  ...
  <div class="ccq-logo">
    <img src="../../img/ch04/question_icon.svg" alt="Question" />
  </div>
</div>
...
* **Explanation:** Non-functional requirements specify constraints (timing, reliability, security, compliance) that apply to the system overall.
  ...
  <div class="ccq-logo">
    <img src="../../img/ch04/answer_icon.svg" alt="Answer" />
  </div>
</div>
...
<div style="text-align: center; margin-top: 15px;">
  <img src="../../img/ch04/elicitation_loop.svg" style="max-height: 440px;" alt="Elicitation Loop" />
</div>
...
4. The **`___`** Control Board evaluates the impact and cost of proposed requirements changes.
  ...
  <div class="fill-blank-logo">
    <img src="../../img/ch04/fill_blank_icon.svg" alt="Quiz" />
  </div>
</div>
...
4. The **Change** Control Board evaluates the impact and cost of proposed requirements changes.
  ...
  <div class="fill-blank-logo">
    <img src="../../img/ch04/fill_blank_answer_icon.svg" alt="Quiz Answers" />
  </div>
</div>
