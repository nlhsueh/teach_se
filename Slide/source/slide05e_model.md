...
<div style="text-align: center; margin-top: 10px;">
  <img src="../../img/ch05/uml_perspectives.svg" style="max-height: 600px;" alt="UML Perspectives" />
</div>
...
<div class="split46">
  ...
  * **System Boundaries:**
  ...
  <div class="right">
    <img src="../../img/ch05/context_diagram.png" alt="Context Diagram" />
  </div>
</div>
...
<div class="split46">
  ...
  * **UML Activity Diagrams:**
  ...
  <div class="right">
    <img src="../../img/ch05/activity_diagram.png" alt="Activity Diagram" />
  </div>
</div>
...
* **Detailed Sub-modules:**
  * **Chapter 5a:** Use Case Diagrams in Detail
  * **Chapter 5b:** Sequence Diagrams in Detail
* **Overview:**
  * These interaction diagrams map the functional requirements to external actors and specify the chronological messages between system elements.
---
...
* **D.** State Diagram
  ...
  <div class="ccq-logo">
    <img src="../../img/ch05/question_icon.svg" alt="Question" />
  </div>
</div>
...
* **Explanation:** Sequence diagrams list objects along the top and show chronological message calls down vertical lifelines.
  ...
  <div class="ccq-logo">
    <img src="../../img/ch05/answer_icon.svg" alt="Answer" />
  </div>
</div>
...
<div class="split55">
  ...
  * **Associations:**
  ...
  <div class="right">
    <img src="../../img/ch05/class_diagram.png" alt="Class Diagram" />
  </div>
</div>
...
<div class="split55">
  ...
  * **Real-Time Systems:**
  ...
  <div class="right">
    <img src="../../img/ch05/state_diagram.png" alt="State Diagram" />
  </div>
</div>
...
<div style="text-align: center; margin-top: 10px;">
  <img src="../../img/ch05/ai_in_system_modeling.svg" style="max-height: 250px;" alt="AI in System Modeling" />
</div>
...
4. **`___`** machine models describe system responses to discrete events by transitioning between states.
  ...
  <div class="fill-blank-logo">
    <img src="../../img/ch05/fill_blank_icon.svg" alt="Quiz" />
  </div>
</div>
...
4. **State** machine models describe system responses to discrete events by transitioning between states.
  ...
  <div class="fill-blank-logo">
    <img src="../../img/ch05/fill_blank_answer_icon.svg" alt="Quiz Answers" />
  </div>
</div>
